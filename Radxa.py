...
class ArduinoMonitor:
    def __init__(self, root):
        ...
        self.pot_data = {
            'Pot1': {'values': deque(), 'times': deque(), 'all_values': [], 'all_times': [], 'enabled': False, 'color': '#e74c3c', 'offset': 0, 'min_session': None, 'max_session': None},
            'Pot2': {'values': deque(), 'times': deque(), 'all_values': [], 'all_times': [], 'enabled': False, 'color': '#3498db', 'offset': 0, 'min_session': None, 'max_session': None},
            'Pot3': {'values': deque(), 'times': deque(), 'all_values': [], 'all_times': [], 'enabled': False, 'color': '#2ecc71', 'offset': 0, 'min_session': None, 'max_session': None},
            'Pot4': {'values': deque(), 'times': deque(), 'all_values': [], 'all_times': [], 'enabled': False, 'color': '#f39c12', 'offset': 0, 'min_session': None, 'max_session': None},
            'Pot5': {'values': deque(), 'times': deque(), 'all_values': [], 'all_times': [], 'enabled': False, 'color': '#9b59b6', 'offset': 0, 'min_session': None, 'max_session': None}
        }
